            ...
            <div class="bg-white dark:bg-gray-800 shadow sm:rounded-lg">
                <div class="max-w-xl">
                    <section>
                        ...
                        <form method="POST" action="{{ route('timecard-update-requests.store') }}" class="mt-6 space-y-6">
                            @csrf
                            ...
                            <div>
                                ...
                                <x-text-input id="date_formatted" type="text" class="mt-1 block w-full bg-gray-100 dark:bg-gray-700"
                                    value="{{ $formData['date_formatted'] }}" readonly />
                            </div>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <x-text-input id="clock_in" name="clock_in" type="time" class="mt-1 block w-full"
                                        :value="old('clock_in', $formData['clock_in'])" required />
                                ...
                                <div>
                                    ...
                                    <x-text-input id="clock_out" name="clock_out" type="time" class="mt-1 block w-full"
                                        :value="old('clock_out', $formData['clock_out'])" required />
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <x-text-input id="break_start" name="break_start" type="time" class="mt-1 block w-full"
                                        :value="old('break_start', $formData['break_start'])" required />
                                ...
                                <div>
                                    ...
                                    <x-text-input id="break_end" name="break_end" type="time" class="mt-1 block w-full"
                                        :value="old('break_end', $formData['break_end'])" required />
                                    <x-input-error class="mt-2" :messages="$errors->get('break_end')" />
                                </div>
                            </div>

                            <div>
                                <x-input-label for="reason" :value="__('申請理由')" />
                                <textarea id="reason" name="reason" required
                                    class="mt-1 block w-full border-gray-300 dark:border-gray-700 dark:bg-gray-700 dark:text-gray-300 focus:border-indigo-500 dark:focus:border-indigo-600 focus:ring-indigo-500 dark:focus:ring-indigo-600 rounded-md shadow-sm"
