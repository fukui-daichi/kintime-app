...
class RequestService
{
     ...
     * @param string|null $status ステータスフィルタ
     * @return array 申請一覧データと画面表示に必要な情報
     */
     ...
     * @param array &$updateData 更新データ配列（参照渡し）
     * @return void
     * @throws \Exception エラー発生時
     */
     ...
     *
     * @param Request $request 申請データ
     * @param string $prefix プレフィックス（before/after）
     * @return array フォーマット済み時間データ
     */
